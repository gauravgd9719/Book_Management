...
In this Backend project, We Handle The backend part of Book management. 
This project have three part First part is User, any one can create user account using credentials. Second part is Book which is created by the user and third part is review on the book.
The User can add book on this website and other user can review that book.
Techonology : Javascript, Nodejs, Express, MongoDb, JWT, authentication, authorisation.

### Key points
- Create a group database `groupXDatabase`. You can clean the db you previously used and resue that.
- This time each group should have a *single git branch*. Coordinate amongst syourselves by ensuring every next person pulls the code last pushed by a team mate. You branch will be checked as part of the demo. Branch name should follow the naming convention `project/booksManagementGroupX`
